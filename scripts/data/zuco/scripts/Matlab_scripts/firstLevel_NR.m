...
// The firstLevel_NR.m is a comprehensive MATLAB script that processes eye-tracking and EEG data from the ZuCo 
// Natural Reading (NR) task. Let me break down its main components:
// It does: 1. data loading and organization; eye-tracking processing (FFD, SFD, TRT, GD, GPT, nFixation, meanPupilSize)
// EEG processing, Data quality control
